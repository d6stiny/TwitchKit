...
struct TwitchKitTests {
    ...
    func testParseMessage() throws {
        ...
        #expect(parsedMessage.username == "testuser")
        #expect(parsedMessage.displayName == "TestUser")
        #expect(parsedMessage.channel == "channel")
        #expect(parsedMessage.message == "Kappa Hello Kappa World")
        #expect(parsedMessage.color == "#0000FF")
        #expect(parsedMessage.badges["subscriber"] == "6")
        #expect(parsedMessage.badges["premium"] == "1")
